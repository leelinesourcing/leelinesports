...
- .claude/new-site/brief.md (brand brief)
- .claude/new-site/directions.json (all directions — you need context on the chosen one AND any cherry-picked elements)
...
**Direction to refine:** [DIRECTION NUMBER AND NAME]
**Student feedback:** [PASTE STUDENT'S FEEDBACK / CHERRY-PICK NOTES HERE]
...
After auditing every section, produce your refinement plan: